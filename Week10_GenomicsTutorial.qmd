...
There is weak evidence that rs12225351 genotype has an effect on height. But on average individuals homozygous for the alternative allele are taller by 0.15 cm, and there is a progressive effect of allele on height (BUT not a significant difference so effect sizes should not be discussed).
